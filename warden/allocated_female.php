...
<head>
    ...
    <title>Female Allocated Students - Hostel System</title>
...
<body>
    <div class="full-page-container">
        <div class="full-content-card">
            ...
            <h1>Female Students <span class="count-badge"><?php echo $totalCount; ?></span></h1>
                        ...
                        <tr>
                            ...
                            <td>
                                <form method="POST" action="vacate_student.php">
                                    ...
                                    <input type="hidden" name="return_page" value="allocated_female.php">
            ...
            <?php else: ?>
                <p>No female students allocated yet.</p>
            <?php endif; ?>
