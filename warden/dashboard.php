...
$db = new Database();
$sql = "SELECT name FROM users WHERE userID = {$_SESSION['user_id']}";
$result = $db->query($sql);
...
<body>
    <div class="dashboard-container">
        ...
        <div class="buttons-row">
            ...
            <a href="allocate.php" class="nav-btn">Allocate Room</a>
            <a href="allocated.php" class="nav-btn">Allocated Students</a>
