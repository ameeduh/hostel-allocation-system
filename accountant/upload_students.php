...
if($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['upload_csv'])) {
    if(isset($_FILES['csv_file']) && $_FILES['csv_file']['error'] == 0) {
        ...
        if(($handle = fopen($fileName, 'r')) !== false) {
            ...
            $message = "Upload complete! $successCount students added/updated. $errorCount errors.";
            $messageType = "success";
        } else {
...
// Get current semester students count
$countSql = "SELECT COUNT(*) as total FROM paid_students WHERE status = 'active'";
...
<head>
    ...
    <title>Upload Paid Students - Accountant Portal</title>
    <style>
        *{margin:0;padding:0;box-sizing:border-box;}
        ...
        .btn-upload{background-color:#2e7d32;color:white;border:none;padding:10px 25px;border-radius:5px;cursor:pointer;font-size:14px;font-weight:600;}
        .btn-upload:hover{background-color:#1b5e20;}
        ...
        .info-box{background:#e3f2fd;padding:15px;border-radius:8px;margin-top:20px;border-left:4px solid #2196f3;}
...
<div class="nav-bar">
    ...
    <div class="nav-links">
        ...
        <a href="upload_students.php" class="active">Upload Paid Students</a>
...
<div class="welcome-section">
    ...
    <p>Upload CSV of students who have paid fees</p>
</div>
<div class="content-area">
    <div class="content-card">
        <h2>Upload Paid Students (CSV)</h2>
            ...
            <form method="POST" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <small style="color:#666; display:block; margin-top:5px;">
                        CSV format: regNumber,name (first row headers, then data rows)
                    </small>
                </div>
                <button type="submit" name="upload_csv" class="btn-upload">Upload CSV</button>
            </form>
        </div>
        ...
        <div class="info-box">
            ...
            regNumber,name<br>
            BscICT/24/001,John Doe<br>
            BscICT/24/002,Jane Smith<br>
            BscNM/22/001,Peter Mutharika<br><br>
            <strong>📊 Currently Active Paid Students:</strong> <?php echo $totalActive; ?> students
        </div>
    </div>
</div>
<div class="footer">
